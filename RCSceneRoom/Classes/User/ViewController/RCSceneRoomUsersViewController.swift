//
//  RCSceneRoomUsersViewController.swift
//  RCE
//
...
extension RCSceneRoomUsersViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let dependency = RCSceneRoomUserOperationDependency(room: room,
                                                            userId: user.userId,
                                                            userRole: userType,
        ...
        let controller = RCSceneRoomUserOperationViewController(dependency: dependency,
                                                     delegate: delegate)
