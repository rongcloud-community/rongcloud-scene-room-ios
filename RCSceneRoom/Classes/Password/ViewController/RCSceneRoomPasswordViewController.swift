//
//  RCSceneRoomPasswordViewController.swift
//  RCE
//
...
public class RCSceneRoomPasswordViewController: UIViewController {
    ...
    private lazy var passwordViews: [RCSceneRoomPasswordNumberView] = {
        var list = [RCSceneRoomPasswordNumberView]()
        for i in 0...3 {
            list.append(RCSceneRoomPasswordNumberView())
        }
        return list
    }()
    ...
    private let type: RCSceneRoomPasswordType
    
    public init(type: RCSceneRoomPasswordType,
                delegate: RCSceneRoomPasswordProtocol?) {
...
extension RCSceneRoomPasswordViewController: UITextFieldDelegate {
