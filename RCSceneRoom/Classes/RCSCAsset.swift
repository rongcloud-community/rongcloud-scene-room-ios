...
public enum RCSCAsset {
  public enum Images {
    ...
    public static let homeIconNew = ImageAsset(name: "home_icon_new")
    public static let homeIconPro = ImageAsset(name: "home_icon_pro")
    public static let homeIconRadioRoom = ImageAsset(name: "home_icon_radio_room")
    public static let homeIconVideoCall = ImageAsset(name: "home_icon_video_call")
    public static let homeIconVideoRoom = ImageAsset(name: "home_icon_video_room")
    public static let homeIconVoiceCall = ImageAsset(name: "home_icon_voice_call")
    public static let homeIconVoiceRoom = ImageAsset(name: "home_icon_voice_room")
    public static let editUserAvatarIcon = ImageAsset(name: "edit_user_avatar_icon")
    public static let homeRadioRoom = ImageAsset(name: "home_radio_room")
    public static let liveVideoHomeBg = ImageAsset(name: "live_video_home_bg")
    public static let messageButtonIcon = ImageAsset(name: "message_button_icon")
    public static let userEditImage = ImageAsset(name: "user_edit_image")
    public static let videoLiveRoomBackground = ImageAsset(name: "video_live_room_background")
    public static let voiceCallRoomBackground = ImageAsset(name: "voice_call_room_background")
    public static let voiceRoomBackground = ImageAsset(name: "voice_room_background")
    public static let countrySelectIndicator = ImageAsset(name: "country_select_indicator")
    ...
    public static let logoffIcon = ImageAsset(name: "logoff_icon")
    public static let logoutIcon = ImageAsset(name: "logout_icon")
    public static let privacyIcon = ImageAsset(name: "privacy_icon")
    public static let registerTerm = ImageAsset(name: "register_term")
    ...
    public static let feedbackAudioIcon = ImageAsset(name: "feedback_audio_icon")
    public static let feedbackAwakedIcon = ImageAsset(name: "feedback_awaked_icon")
    public static let feedbackInteraction = ImageAsset(name: "feedback_interaction")
    public static let feedbackSceneIcon = ImageAsset(name: "feedback_scene_icon")
    public static let feedbackSmileIcon = ImageAsset(name: "feedback_smile_icon")
    public static let feedbackUsageIcon = ImageAsset(name: "feedback_usage_icon")
    public static let promotion = ImageAsset(name: "promotion")
    public static let promotionItemAbout = ImageAsset(name: "promotion_item_about")
    public static let promotionItemDemo = ImageAsset(name: "promotion_item_demo")
    public static let promotionItemOnline = ImageAsset(name: "promotion_item_online")
    public static let promotionItemScheme = ImageAsset(name: "promotion_item_scheme")
    public static let service = ImageAsset(name: "service")
    ...
    public static let recordVoice1 = ImageAsset(name: "record_voice_1")
    public static let recordVoice2 = ImageAsset(name: "record_voice_2")
    public static let recordVoice3 = ImageAsset(name: "record_voice_3")
    public static let recordVoiceCancel = ImageAsset(name: "record_voice_cancel")
    public static let recordVoiceHighlighted = ImageAsset(name: "record_voice_highlighted")
    public static let recordVoiceNormal = ImageAsset(name: "record_voice_normal")
    public static let recordVoiceRecording = ImageAsset(name: "record_voice_recording")
    public static let tabBarDiscover = ImageAsset(name: "tab_bar_discover")
    public static let tabBarHome = ImageAsset(name: "tab_bar_home")
    public static let tabBarMine = ImageAsset(name: "tab_bar_mine")
