...
public class RCSceneRoomUserOperationViewController: UIViewController {
    ...
    public weak var delegate:RCSceneRoomUserOperationProtocol?
    ...
    public init(dependency: RCSceneRoomUserOperationDependency,
    ...
    private func fetchUserInfo() {
        RCSceneUserManager.shared.refreshUserInfo(userId: dependency.userId) { [weak self] user in
    ...
    @objc private func handleSendMessage() {
        ...
        dismiss(animated: true) {
            delegate?.didClickedPrivateChat(userId: userId)
        }
    }
