//
//  RCSRSettingViewController.swift
//  RCE
//
...
public class RCSRSettingViewController: UIViewController {
...
extension RCSRSettingViewController: UICollectionViewDataSource {
...
extension RCSRSettingViewController: UICollectionViewDelegate {
        ...
        case .roomLock(let lock):
            if lock {
                ...
                controller.completion = { [weak self] password in
                    delegate.eventDidTrigger(item, extra: password)
                }
