...
protocol RCSceneGiftCountViewControllerDelegate: AnyObject {
    func onGiftCountSelected(_ count: Int)
}

public final class RCSceneGiftCountViewController: UIViewController {
    
    private let sendView: VoiceRoomGiftSendView
    
    private lazy var backView = UIView()
    private lazy var menuView = RCSceneGiftCountMenuView()
...
extension RCSceneGiftCountViewController {
...
final class RCSceneGiftCountMenuView: UIView {
