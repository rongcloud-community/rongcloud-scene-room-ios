//
//  AlignCollectionViewLayout.swift
//  RCE
//
...
/// A horizontal alignment used internally by `RCSceneFlowLayout`
...
open class RCSceneFlowLayout: UICollectionViewFlowLayout {
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func isRepresentingFirstItemInLine(collectionViewLayout: RCSceneFlowLayout) -> Bool {
        if currentItem <= 0 {
            return true
        }
        else {
    ...
    func isRepresentingLastItemInLine(collectionViewLayout: RCSceneFlowLayout) -> Bool {
    ...
    private func alignToPrecedingItem(collectionViewLayout: RCSceneFlowLayout) {
    ...
    ///
    /// - Parameter collectionViewLayout: The layout on which to perfom the calculations.
    private func alignToFollowingItem(collectionViewLayout: RCSceneFlowLayout) {
        let itemSpacing = collectionViewLayout.minimumInteritemSpacing
    ...
    func alignHorizontally(collectionViewLayout: RCSceneFlowLayout) {
    ...
    func alignVertically(collectionViewLayout: RCSceneFlowLayout) {
