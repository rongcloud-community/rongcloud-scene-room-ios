...
extension UIViewController {
    public func dismissCurrentPresent(completion: @escaping (() -> Void)) {
    ...
    public func currentVisableViewController() -> UIViewController? {
    ...
    public func safe_presentViewController(vc: UIViewController, animated: Bool, completion: (() -> Void)?) {
